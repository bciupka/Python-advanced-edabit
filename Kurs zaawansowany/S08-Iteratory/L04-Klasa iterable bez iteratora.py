class CobinationsIterator:

    def __init__(self, comb):
        self.products = comb.products
        self.promotions = comb.promotions
        self.customers = comb.customers
...
class Combinations:
    ...
    def __init__(self, products, promotions, customers):
        ...
        self.iterator = CobinationsIterator(self)
