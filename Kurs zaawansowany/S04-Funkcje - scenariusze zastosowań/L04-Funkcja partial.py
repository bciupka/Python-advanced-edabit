...
# dir = r'D:\Projekty\PyCharm\temp\S04-L04'
# msg = "Please wait - the file {} will be downloaded"
# save_url_lite = functools.partial(save_url_file, dir = dir, msg = msg)

save_url_lite = functools.partial(save_url_file, dir = r'D:\Projekty\PyCharm\temp\S04-L04', msg = 'Please wait: {}')

url = 'http://mobilo24.eu/spis'
file = 'spis.html'
# save_url_file(url, dir, file, msg)
save_url_lite(url = url, file = file)
